...
# Kombinierte Liste: Deine 51 Hauptaktien + 33 neue Watchlist-Aktien
meine_aktien = [
    # --- HAUPTAKTIEN ---
...
for aktie in meine_aktien:
    try:
        ...
        if not hist_5y.empty and not hist_1m.empty:
            ...
            # Erweiterte Währungserkennung anhand des Tickers
            sym = aktie["symbol"]
            rate = 1.0
            ...
            # Sichere Performance-Berechnungen

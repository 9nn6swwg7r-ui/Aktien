...
# Komplett bereinigte und lückenlose Liste ALLER Aktien aus deinen 11 Screenshots
meine_aktien = [
    # --- DEPOT AKTIEN ---
    ...
    {"symbol": "T", "name": "AT&T", "logoUrl": "https://logo.clearbit.com/att.com", "tags": ["Telekom", "USA"], "watchlist": True},
